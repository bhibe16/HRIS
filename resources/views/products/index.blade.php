...
<body class="relative bg-gray-100 min-h-screen">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen bg-gray-900 text-white transform -translate-x-full transition-transform sm:translate-x-0">
        <div class="h-full px-3 py-4 overflow-y-auto">
            ...
            <ul class="mt-4 space-y-2 font-medium">
                <li>
                    <a href="dashboard" class="flex items-center p-2 text-gray-200 rounded hover:bg-gray-700">
                ...
                <li>
                    <a href="{{ route('product.index') }}" class="flex items-center p-2 text-gray-200 rounded hover:bg-gray-700">
    ...
    <thead class="bg-gray-800">
        <tr>
            ...
            <th class="py-2 px-4 border-b text-left">Picture</th> <!-- Add this -->
